package _3_Array_and_function_in_java.excercise.bt4;

//Bước 1: tìm phần tử lớn nhất của ma trận có sẵn
//
//        Dùng mảng hai chiều để phản ánh ma trận.
//
//        Dùng phương pháp khởi tạo nhanh để tạo ra ma trận có sẵn các phần tử.
//        Khai báo một biến số thực để chứa giá trị lớn nhất tìm kiếm được, và hai số nguyên để chứa tọa độ của giá trị lớn nhất tìm kiếm được,
//        đặt cho những biến đó giá trị tương ứng của một phần tử ở tọa độ bất kỳ trong ma trận. Sử dụng vòng lặp để duyệt qua hết các phần
//        tử của ma trận, cập nhật kết quả mỗi khi tìm thấy giá trị lớn hơn.
//
